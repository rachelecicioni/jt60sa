...
jdir_list = [
    "run_sa_fk_c_WAr_p20_s19_a3_50ms_std",
    "run_sa_fk_c_WAr_p20_a3_50ms"#,
    #"run_sa_fk_c_WAr_p20_s19_a3_50ms_std_nclass"
    ]
...
# ============================================================
fig, axs = plt.subplots(nrows=3, ncols=3, figsize=(15, 10), sharex=False)
(
    ax1, ax2, ax3,
    ax4, ax5, ax6,
    ax7, ax8, ax9
...
# ============================================================
cwall_jsp_path = "/pfs/work/g2rcicio/jt60sa/jettorun_cwall/jetto.jsp"
...
plot_dir = "/pfs/work/g2rcicio/jt60sa/plot"
